...
import pjImage01 from '../images/project01.png';
import pjImage02 from '../images/project02.png';
import layerImage01 from '../images/layer01.png';
import layerImage02 from '../images/layer02.png';
import layerImage03 from '../images/layer03.png';
import layerImage04 from '../images/layer04.png';
import layerImage05 from '../images/layer05.png';
import ftnImage01 from '../images/function01.png';
import ftnImage02 from '../images/function02.png';
import ftnImage03 from '../images/function03.png';
import ftnImage04 from '../images/function04.png';
import ftnImage05 from '../images/function05.png';
import ftnImage06 from '../images/function06.png';
import ftnImage07 from '../images/function07.png';
import ftnImage08 from '../images/function08.png';
let vrIcon = null;
let svrIcon = null;
...
const SchoolVR = (props) => {
  ...
  useEffect(()=>{
    ...
    onWindowScroll = () => {
      ...
      const sm = document.querySelector('#scroll #mobileContact').getBoundingClientRect().top;
        ...
        if(sm <= 100){
          ...
          if(page > 0 && page < 9){
            ...
            if(mobileContactBtn.className === 'active'){
              ...
              TweenMax.to(mobileContactBtn, .3, {scale:0,ease:'Power3.easeInOut'});
            }
          }
        }
      ...
      <div id="scroll">
        ...
        <div id="section02" className="section">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1634.25 801.48">
            ...
            <g>
              <g>
                <circle id="section02Cir01" cx="400.66" cy="400.82" r="400.66" fill="url(#a)" opacity=".29"/>
                <circle id="section02Cir02" cx="1233.59" cy="400.66" r="400.66" fill="url(#b)" opacity=".29"/>
              </g>
            </g>
          </svg>
          <div className="wrap">
          ...
          <div className="content halfWrap">
            ...
            <div className="contact half">
              ...
              <ul className="h6">
                ...
                <li>
                  <p className="cap">20A1, Galaxy Factory Building, <br/>25 Luk Hop St, San Po Kong, <br/>Hong Kong</p>
        ...
        <div id="mobileContact" className="section">
          <div className="content">
            ...
            <div className="wrap">
              <p className="address s cap">20A1, Galaxy Factory Building, <br/>25 Luk Hop St, San Po Kong, <br/>Hong Kong</p>
            </div>
          </div>
        </div>
        {/* <div id="section09">
